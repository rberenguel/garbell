...
- `read-chunk <filepath> <line_number>` — Reads exactly the code block enclosing a specific line number. Capped at **1000 lines**. Use this after `search-lexical`, `search-related`, or `file-skeleton` to read the full body of a specific chunk.
